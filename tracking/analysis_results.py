...
"""ostrack"""
#
# trackers.extend(trackerlist(name='ostrack', parameter_name='nano', dataset_name=dataset_name,
#                             run_ids=None, display_name='nano'))
# trackers.extend(trackerlist(name='ostrack', parameter_name='nano2', dataset_name=dataset_name,
#                             run_ids=None, display_name='nano2'))
trackers.extend(trackerlist(name='ostrack', parameter_name='L_L_resolution', dataset_name=dataset_name,
